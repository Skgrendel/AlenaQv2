...
<head>
<meta charset="UTF-8">
<title>Reporte de Exceso de Capacidad</title>
        ...
        <tr>
            <td style="padding:40px 40px 30px 40px;">
                <h2 style="margin:0 0 20px 0;font-size:20px;color:#003366;font-weight:bold;text-align:center;">
                    Reporte de Exceso de Capacidad Detectado
                </h2>

                <p style="margin:0 0 16px 0;font-size:16px;line-height:1.6;color:#333333;">
                    Se ha detectado un posible exceso de capacidad en el siguiente registro:
                </p>
                ...
                <!-- Sección de Exceso de Capacidad -->
                <div style="margin:30px 0;border:1px solid #ddd;border-radius:4px;overflow:hidden;">
                    <div style="background-color:#ff9900;padding:12px;color:white;font-weight:bold;font-size:16px;">
                        ⚠️ POSIBLE EXCESO DE CAPACIDAD DETECTADO
                    </div>
                </div>

                <p style="margin:30px 0 30px 0;font-size:18px;line-height:1.6;color:#ff6600;text-align:center;font-weight:bold;">
                    Se requiere verificación urgente del punto por posible exceso de capacidad.
