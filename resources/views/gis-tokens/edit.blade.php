                ...
                <div class="widget-content">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Editar Token GIS</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('gis-tokens.update', $gisToken) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('token') is-invalid @enderror"
                                              ...
                                              rows="4"
                                              required
                                              placeholder="Ingrese el token GIS">{{ old('token', $gisToken->token) }}</textarea>
                                    @error('token')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           id="descripcion"
                                           name="descripcion"
                                           value="{{ old('descripcion', $gisToken->descripcion) }}"
                                ...
                                <div class="mb-3 form-check">
                                    <input type="checkbox"
                                           ...
                                           name="activo"
                                           value="1"
                                           {{ old('activo', $gisToken->activo) ? 'checked' : '' }}>
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <small>Creado: {{ $gisToken->created_at->format('d/m/Y H:i') }}</small><br>
                                    <small>Última actualización: {{ $gisToken->updated_at->format('d/m/Y H:i') }}</small>
                                </div>
