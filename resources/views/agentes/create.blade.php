                            ...
                            <div class="widget-content widget-content-area">
                                <div class="col-md-12">
                                    <a class="btn btn-info btn-lg mb-4 me-4" id="foto1-button"
                                        ...
                                        <span class="btn-text-inner">Foto de la Fachada</span>
                                    ...
                                    <a class="btn btn-info btn-lg mb-4 me-4" id="foto2-button"
                                        ...
                                        <span class="btn-text-inner">Centro de Medición</span>
                                    ...
                                    <a class="btn btn-info btn-lg mb-4 me-4" id="foto3-button"
                                        ...
                                        <span class="btn-text-inner">Foto del Odómetro</span>
                                    ...
                                    <a class="btn btn-info btn-lg mb-4 me-4" id="foto4-button"
                                        ...
                                        <span class="btn-text-inner">Foto del Regulador</span>
                                        <input type="file" class="form-control d-none" id="foto4-input" name="foto4"
                                            accept="image/jpeg" capture="camera">
                                    </a>
                                    <a class="btn btn-info btn-lg mb-4 me-4 d-none" id="foto5-button"
                                        style="font-size:16px;width: 250px; height: 50px;">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-0.855 -0.855 24 24"
                                            id="Landscape-1--Streamline-Flex" height="24" width="24">
                                            <desc>Landscape 1 Streamline Icon: https://streamlinehq.com</desc>
                                        ...
                                        <span class="btn-text-inner">Foto Detector de Fuga</span>
                                    ...
                                    <a class="btn btn-info btn-lg mb-4 me-4" id="foto6-button"
                                        ...
                                        <span class="btn-text-inner">Capacidad Interna</span>
                                        <input type="file" class="form-control d-none" id="foto6-input" name="foto6"
                                            accept="image/jpeg" capture="camera">
                                    </a>
                                </div>
                                <hr class="my-2">
