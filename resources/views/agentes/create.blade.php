                ...
                <div class="row">
                    ...
                    <div class="col-6 d-flex justify-content-end">
                        <div class="btn-group me-2" role="group" aria-label="Second group">
                            <input type="radio" class="btn-check" name="options-predio" id="prediosi" autocomplete="off">
                            <label class="btn btn-outline-success" for="prediosi">Si</label>
                            <input type="radio" class="btn-check" name="options-predio" id="prediono" autocomplete="off">
                    ...
                    <div class="col-lg-12 d-none mb-2" id="anomaliaContainer">
                        <div class="mt-1">
                            <label for="slcanomalia" class="form-label">Seleccione La Anomalia Que
                                Detecto</label>
                            <select id="slcanomalia" class="form-select select2" name="anomalia[]" multiple="multiple"
                        ...
                        <div class="col-md-12">
                            <a class="btn btn-info btn-lg mb-4 me-4" id="foto1-button"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-0.855 -0.855 24 24"
                                    id="Landscape-1--Streamline-Flex" height="24" width="24">
                                ...
                                <input type="file" class="form-control d-none" id="foto1-input" name="foto1"
                            ...
                            <a class="btn btn-info btn-lg mb-4 me-4" id="foto2-button"
                                ...
                                <input type="file" class="form-control d-none" id="foto2-input" name="foto2"
                                    accept="image/jpeg" capture="camera">
                            </a>
                            <a class="btn btn-info btn-lg mb-4 me-4" id="foto3-button"
                                ...
                                <input type="file" class="form-control d-none" id="foto3-input" name="foto3"
                                    accept="image/jpeg" capture="camera">
                            </a>
                            <a class="btn btn-info btn-lg mb-4 me-4" id="foto4-button"
                                ...
                                <input type="file" class="form-control d-none" id="foto4-input" name="foto4"
                                    accept="image/jpeg" capture="camera">
                            </a>
                            <a class="btn btn-info btn-lg mb-4 me-4" id="foto5-button"
                                ...
                                <input type="file" class="form-control d-none" id="foto5-input" name="foto5"
                                    accept="image/jpeg" capture="camera">
                            </a>
                            <a class="btn btn-info btn-lg mb-4 me-4" id="video-button"
                                ...
                                <input type="file" class="form-control d-none" id="video-input" name="video"
