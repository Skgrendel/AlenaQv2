                                ...
                                @if (isset($asignados))
                                    @foreach ($asignados as $item)
                                        <tr>
                                            ...
                                            <td>
                                                {!! $item->estado ? ($item->estado === 1 ? '<span class="badge rounded-pill text-bg-warning">' . __("Pendiente") . '</span>' : 'Sin estado') : '<span class="badge rounded-pill text-bg-success">' . __("Registrado") . '</span>'  !!}
                                            </td>
                                            <td>
                                                @if ($item->estado != 0)
